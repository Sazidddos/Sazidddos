...
if (!target || !time || !thread || !proxyFile || !rps) {
 console.error('Error: Please provide the following arguments:');
    ...
    console.error('  rps: The maximum number of requests per second to send. Max 9999');
...
console.log(`SUCCESS: Attack sent successfully! | Target: ${target} | Duration: ${time} seconds | Threads: ${9999999} | Requests per second: ${9999} |`);
