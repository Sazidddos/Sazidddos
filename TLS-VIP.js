 ...
 if (process.argv.length < 5){console.log(`Script By ItzMeSahid\nUsage: node TLS-VIP.js URL TIME REQ_PER_SEC THREADS\nExample: node TLS-VIP.js https://tls.mrrage.xyz 500 8 1`); process.exit();}
