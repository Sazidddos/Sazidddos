...
if (process.argv.length < 5) {
    console.log(`Usage: node TLS4.js URL TIME REQ_PER_SEC THREADS\nExample: node TLS4.js https://tls.mrrage.xyz 500 8 1`);
    process.exit();
}

const defaultCiphers = crypto.constants.defaultCoreCipherList.split(":");
const ciphers = ["GREASE", ...defaultCiphers.slice(2), defaultCiphers[0], ...defaultCiphers.slice(3)].join(":");
